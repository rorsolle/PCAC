function u = MPC(A,B,C,x0,A_ineq_y,B_ineq_y,A_ineq_u,B_ineq_u,lb_x,ub_x,lb_u,ub_u,Q,P,R,N,is_ordered_input)
...
LB = [kron(ones(N+1,1),lb_x);kron(ones(N,1),lb_u)];
UB = [kron(ones(N+1,1),ub_x);kron(ones(N,1),ub_u)];
